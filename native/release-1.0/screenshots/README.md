...
- iphone-store.png：iPhone 17 Pro Max、1320×2868px（6.9インチ枠）
- ipad-store.png：iPad Pro 13-inch (M5)、2064×2752px（13インチ枠）
- Xcode 26.3 / シミュレーターのReleaseビルドで撮影。アプリ部分の合成・加工なし。
- アプリのソースはTestFlight 14.1と同じ（その後の差分は提出文書と撮影スクリプトのみ）。
