...
const scroll=s=>document.querySelector(s).scrollIntoView({block:'start'});
...
setInterval(async()=>{
 ...
 if(cmd.action==='view'){click(`[data-view="${cmd.view}"]`);await sleep(400);if(cmd.scroll)scroll(cmd.scroll);}
